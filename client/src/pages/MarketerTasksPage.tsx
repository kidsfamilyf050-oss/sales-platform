      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="input"
            rows={3}
            placeholder="Контент-план, запуск кампании, согласование..."
            value={title}
  ...
  return (
    <div className="mt-3 pt-3 border-t border-gray-100 space-y-3">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={() => { if (window.confirm('Удалить задачу?')) deleteMut.mutate() }} disabled={deleteMut.isPending}
    ...
    <div className="space-y-5 px-4 md:px-6 py-2 md:py-4">
      ...
      <div className="flex items-start justify-between gap-2">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-0.5">Контент, кампании, запуски</p>
        </div>
        <button
