...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 text-base sm:text-lg leading-tight">Sirius<br className="sm:hidden" /> Track</span>
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
            <LanguageSwitcher />
            {user ? (
              <Link to="/app" className="flex items-center gap-1.5 bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">
              ...
              <>
                ...
                <Link to="/register" className="bg-blue-600 text-white px-3 sm:px-5 py-2 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors shadow-sm whitespace-nowrap">
      ...
      {/* Hero */}
      <section className="pt-24 sm:pt-28 pb-0 px-4 sm:px-6 bg-gradient-to-b from-blue-50/60 to-white overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 text-blue-600 px-3 sm:px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold mb-6 sm:mb-8">
            <Zap className="w-3 h-3 sm:w-3.5 sm:h-3.5 flex-shrink-0" />
            {t('landing.notcrm')}
          </div>
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-[1.05] mb-2 sm:mb-3">
            {t('landing.hero.title')}
          </h1>
          <h2 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-blue-600 leading-[1.05] mb-5 sm:mb-8">
            {t('landing.hero.subtitle')}
          </h2>
          <p className="text-base sm:text-xl text-gray-500 mb-7 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
            {t('landing.hero.desc')}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-4 sm:mb-5">
            <Link to="/register" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 text-white px-8 py-3.5 sm:py-4 rounded-xl text-base font-semibold hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 hover:shadow-xl hover:-translate-y-0.5">
              {t('landing.cta.btn' as any)} <ArrowRight className="w-5 h-5" />
            </Link>
            <Link to="/login" className="w-full sm:w-auto flex items-center justify-center gap-2 border border-gray-200 text-gray-700 px-8 py-3.5 sm:py-4 rounded-xl text-base font-semibold hover:bg-gray-50 transition-colors">
              {t('landing.hero.login')}
            </Link>
          </div>
          <p className="text-xs sm:text-sm text-gray-400 mb-10 sm:mb-16">{t('landing.hero.regNote')}</p>
      ...
      <section className="py-10 sm:py-14 border-y border-gray-100 bg-gray-50/50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 grid grid-cols-3 gap-3 sm:gap-6 text-center">
          {[
            ...
            <div key={s.labelKey}>
              <div className="text-2xl sm:text-4xl font-extrabold text-blue-600 mb-1">{s.value}</div>
              <div className="text-xs sm:text-sm text-gray-500">{t(s.labelKey as any)}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-2xl mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.pain.title')}</h2>
            <p className="text-sm sm:text-base text-gray-500 leading-relaxed">{t('landing.pain.subtitle')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            {painScenarios.map((p, i) => (
              <div key={i} className={`bg-white border ${p.border} rounded-2xl p-4 sm:p-6 flex gap-3 sm:gap-4 shadow-sm`}>
                <div className={`w-9 h-9 sm:w-10 sm:h-10 ${p.bg} rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5`}>
                  <p.icon className={`w-4 h-4 sm:w-5 sm:h-5 ${p.ic}`} />
                </div>
                <div>
                  <div className="font-semibold text-gray-900 text-sm sm:text-base mb-1">{p.scene}</div>
                  <div className="text-xs sm:text-sm text-gray-400">{p.result}</div>
                </div>
              </div>
            ))}
          </div>
          <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5">
            ...
            <div className="flex-1">
              <div className="font-bold text-gray-900 mb-1 text-sm sm:text-base">{t('landing.pain.callout' as any)}</div>
              <div className="text-xs sm:text-sm text-gray-500">{t('landing.pain.callout.sub' as any)}</div>
            </div>
            <Link to="/register" className="w-full sm:w-auto flex items-center justify-center gap-1.5 bg-blue-600 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-blue-700 transition-colors whitespace-nowrap">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="max-w-xl mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.compare.title' as any)}</h2>
          </div>
          <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm">
            <div className="grid grid-cols-2 bg-gray-900">
              <div className="px-3 sm:px-6 py-3 sm:py-4 flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="font-semibold text-gray-300 text-xs sm:text-sm">{t('landing.compare.before' as any)}</span>
              </div>
              <div className="px-3 sm:px-6 py-3 sm:py-4 flex items-center gap-1.5 sm:gap-2 bg-blue-600">
                <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white flex-shrink-0" />
                <span className="font-semibold text-white text-xs sm:text-sm">{t('landing.compare.after' as any)}</span>
              </div>
            </div>
            {compareRows.map((row, i) => (
              <div key={i} className={`grid grid-cols-2 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}`}>
                <div className="px-3 sm:px-6 py-3 sm:py-4 flex items-start gap-2 sm:gap-3 border-r border-gray-100">
                  <XCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 flex-shrink-0 mt-0.5" />
                  <span className="text-xs sm:text-sm text-gray-500">{row.b}</span>
                </div>
                <div className="px-3 sm:px-6 py-3 sm:py-4 flex items-start gap-2 sm:gap-3">
                  <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-500 flex-shrink-0 mt-0.5" />
                  <span className="text-xs sm:text-sm font-medium text-gray-800">{row.a}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="max-w-xl mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.how.title')}</h2>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-xl mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.roles.title')}</h2>
            <p className="text-sm sm:text-base text-gray-500">{t('landing.roles.sub' as any)}</p>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-xl mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.features.title')}</h2>
            <p className="text-sm sm:text-base text-gray-500">{t('landing.features.subtitle')}</p>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-xl mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.social.title' as any)}</h2>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="max-w-xl mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.pricing.title')}</h2>
            <p className="text-sm sm:text-base text-gray-500">{t('landing.pricing.subtitle')}</p>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{t('landing.faq.title' as any)}</h2>
          </div>
          <FAQ items={faqItems} />
        </div>
      </section>
      ...
      {/* Final CTA */}
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-blue-600">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl sm:text-4xl font-bold text-white mb-3 sm:mb-4">{t('landing.cta.title' as any)}</h2>
          <p className="text-blue-100 mb-7 sm:mb-10 leading-relaxed text-base sm:text-lg">{t('landing.cta.desc' as any)}</p>
      ...
      <footer className="py-8 sm:py-10 px-4 sm:px-6 border-t border-gray-100 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center sm:justify-between gap-4 sm:gap-6 text-center sm:text-left">
          <div className="flex items-center gap-2">
