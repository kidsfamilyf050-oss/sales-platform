...
import { Shield, Building2, Users, BarChart2, LogOut, History, ShieldCheck, FileText, DollarSign } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-950 flex">
      ...
      <aside className="w-56 bg-gray-900 border-r border-gray-800 flex flex-col p-4">
        ...
        <nav className="flex-1 space-y-1">
          ...
          <NavItem to="/sys-ctl-9x7/plan-requests" icon={FileText} label="Заявки" />
          <NavItem to="/sys-ctl-9x7/payments" icon={DollarSign} label="Оплаты" />
          <NavItem to="/sys-ctl-9x7/audit" icon={History} label="История" />
          <NavItem to="/sys-ctl-9x7/admins" icon={ShieldCheck} label="Администраторы" />
        </nav>
